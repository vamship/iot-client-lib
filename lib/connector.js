...
/**
 * @class Connector
 * @method _ensureLogger
 * @private
 */
Connector.prototype._ensureLogger = function() {
    if (!this._logger || typeof this._logger !== 'object') {
        this._logger = {};
    }
    ['silly', 'debug', 'verbose',
        'info', 'warn', 'error'
    ].forEach(function(methodName) {
        if (typeof this._logger[methodName] !== 'function') {
            this._logger[methodName] = function() {}
        }
    }.bind(this));
};
