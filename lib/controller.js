 ...
 * @param {String} request A request object that can be used to notify the
 *          cloud of actions taken by the controller.
 * @return {Object} A promise that is resolved or rejected based on the
 *          result of the initialization process.
 */
Controller.prototype.init = function(configFilePath, request) {
    if(!request || typeof request !== 'object') {
        throw new Error('Invalid request object specified (arg #1)');
    }
 ...
 *          cloud of actions taken by the controller.
 */
Controller.prototype.stop = function(request) {
    if(!request || typeof request !== 'object') {
        throw new Error('Invalid request object specified (arg #1)');
    }
    var def = _q.defer();
